            ...
            <template class="form-group" v-for="(field, k) in native_schema" v-if="field.visible(model)">
                <el-col :sm="24" :class="field.wrapperclass">
                    <template v-if="field.type == 'input'">
                        ...
                        <template v-else>
                            ...
                            <template v-for="(opt_label, opt_value) in field.options">
                                <label :style="{display: field.vertical == true ? 'block' : 'inline'}">
                    ...
                    <template v-if="field.type == 'repeatable'">
                                ...
                                <el-collapse-item title="Option" :name="k">
                                    <div class="panel panel-default mb5 panel-repeatable">
                                        <div class="panel-heading card-header oh">
                                            ...
                                            <a @click="removeItem(model[field.model],k)" href="javascript:" class="woopo_btn-flat pull-right btn-danger btn-default btn-sm btn-outline"><i class="el-icon el-icon-remove-outline"></i></a>
                                            <a href="javascript:" @click="moveItemUp(model[field.model],k)" class="woopo_btn-flat pull-right btn-light btn-default btn-sm btn-outline"><i class="el-icon el-icon-arrow-up"></i></a>
                                            <a href="javascript:" @click="moveItemDown(model[field.model],k)" class="woopo_btn-flat pull-right btn-light btn-default btn-sm btn-outline"><i class="el-icon el-icon-arrow-down"></i></a>
                                        </div>
                        ...
                        <a @click="addItem(model[field.model],field.group)" href="javascript:" class="btn btn-success woopo_btn-flat">{{ field.add_button_label }}</a>
                    </template>
